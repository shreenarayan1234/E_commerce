...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="Dashboard/images/watch.png" />
</head>
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="{{URL::to('admin')}}"><img src="Dashboard/images/logo.png"
            class="mr-2" alt="logo" /></a>
        <a class="navbar-brand brand-logo-mini" href="{{URL::to('admin')}}"><img src="Dashboard/images/logo-mini.svg"
            alt="logo" /></a>
      </div>
